...
<script language="C#" runat="server">
    ...
    void loadPatTable()
    {
        ...
        strSelect ="SELECT Pat_ID, Pat_Name_F, Pat_Name_L, Pat_Gender, Pat_DOB as 'Age' FROM patient";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        tableOut += "<thead><tr class='font-weight-bold'><td>Name</td><td>Date of Birth</td><td>Gender</td></tr></thead>";
        while(objDataReader.Read())
        {
            ...
            tableOut += "<td>" + objDataReader["Pat_Gender"].ToString() + "</td>";
            tableOut += "<td style='text-align:center'><a href='oa_select_doctor.aspx?&patid=" + objDataReader["Pat_ID"].ToString() + "' class='btn btn-tbl-edit btn-xs'><i class='fa fa-check'></i></a></td>";
            tableOut += "</tr>";
        }
        tableOut += "</table>";
        //Set page placeholders
        patTable.InnerHtml = tableOut;
    }
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card  card-box">
                                                    ...
                                                    <div class="card-body ">
                                                        <div class="table-scrollable" id="patTable" runat="server">
