...
<script language="C#" runat="server">
    ...
    void loadPastApptTable()
    {
        //Loads components specific to appointment count
        string strSelect;
        string strConnect;

        strSelect = "SELECT Pat_Name_F, Pat_Name_L, Pat_Email, Pat_Phone, Appt_Date, Diag_Desc FROM patient p, appointment a, doctor d, diagnosis di WHERE d.Doc_ID = a.Appt_ID AND p.Pat_ID = a.Appt_ID AND di.Diag_Appt_ID = Appt_ID AND Appt_Date < CONVERT (date, SYSDATETIME())";
        strConnect = "server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        tableOut += "<thead><tr><td>Patient Name</td><td>Email</td><td>Date of Appointment</td><td>Phone</td><td>Diagnosis</td></tr></thead>";
        while (objDataReader.Read()) {
            ...
            tableOut += "<td>" + objDataReader["Diag_Desc"].ToString() + "</td>";
            tableOut += "</tr>";
        }
        tableOut += "</table>";
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Past Appointments</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
