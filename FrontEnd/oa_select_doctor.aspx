...
<script language="C#" runat="server">
    ...
    void loadFutureApptTable()
    {
        ...
        strSelect ="SELECT Doc_ID, Doc_Name_F, Doc_Name_L, Doc_Email, Doc_Phone, Doc_Specialization, Doc_Addr_City, Doc_Addr_State FROM doctor";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        while(objDataReader.Read())
        {
            ...
            if(objDataReader["Doc_Specialization"].ToString() == "General Doctor"){
                tableOut += "<td style='text-align:center'><a href='oa_book_appointment.aspx?&docid=" + objDataReader["Doc_ID"].ToString() + "&patid=" + patid + "' class='btn btn-tbl-edit btn-xs'><i class='fa fa-check'></i></a></td>";
            } else {
                tableOut += "<td style='text-align:center'><a href='oa_request_specialist.aspx?&docid=" + objDataReader["Doc_ID"].ToString() + "&patid=" + patid + "' class='btn btn-tbl-edit btn-xs'><i class='fa fa-check'></i></a></td>";
            }
            tableOut += "</tr>";
        }
        tableOut += "</table>";
