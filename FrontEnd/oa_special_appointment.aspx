...
<script language="C#" runat="server">
    ...
    void acceptRequest(string id){
        ...
        strSelect ="UPDATE approval SET App_Given = 1 WHERE App_ID =" + id ;
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        // string tableOut = "<td> Request Accepted </td>";
        // accept.InnerHtml = tableOut;
    }
    void rejectRequest(string id){
        string strSelect;
        string strConnect;

        strSelect ="UPDATE approval SET App_Given = 0 WHERE App_ID =" + id;
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        // tring tableOut = "<td> Request Rejected </td>";
        // reject.InnerHtml = tableOut;
    }
    void displayRequestMsg(string action){
        string outMessage = "";
        if(action == "a"){
            outMessage = "<font color=\"green\">Patient request ACCEPTED</font>";
        }
        if(action == "r"){
            outMessage = "<font color=\"red\">Patient request REJECTED</font>";
        }
        request.InnerHtml = outMessage;
    }
    void loadSpecApptTable()
    {
        //Loads components specific to appointment count
        string strSelect;
        string strConnect;

        strSelect ="SELECT Pat_Name_F, Pat_Name_L, Doc_Name_F, Doc_Name_L, Doc_Specialization, App_ID, App_Given FROM approval, doctor, patient WHERE App_Pat_ID = Pat_ID AND App_Doc_ID = Doc_ID AND App_Given IS null AND Doc_Specialization != 'General Doctor'";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        tableOut += "<thead><tr><td class='font-weight-bold' style='width:25%'>Patient Name</td><td class='font-weight-bold'>Requested Doctor</td><td class='font-weight-bold'>Specialization</td></tr></thead>";
        ...
        specApptTable.InnerHtml = tableOut;
    }
</script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Specialist Appointment Requests</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Specialist Appointments</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card  card-box">
                                ...
                                <div class="card-body ">
                                    <div class="table-scrollable" id="specApptTable" runat="server">
                                        <table id="tableExport" class="display table table-hover table-checkable order-column m-t-20" style="width: 100%" placeholder="No Request Available">
                                        </table>
                                    </div>
