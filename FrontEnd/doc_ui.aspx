...
<script language="C#" runat="server">
    ...
    void loadApptData(HttpCookie uInfo)
    {
        ...
        strSelectA = "SELECT count(Appt_ID) as 'cnt' FROM appointment WHERE Appt_Doc_ID = @EID AND Appt_Date = CONVERT (date, SYSDATETIME())";
        strSelectB = "SELECT count(Appt_ID) as 'cnt' FROM appointment WHERE Appt_Doc_ID = @EID AND (Appt_Date BETWEEN '20190401' AND '20190430')"; //TODO: Verify
        strConnect = "server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="info-box bg-white">
                                    <span class="info-box-icon push-bottom bg-primary"></span>
                                    <div class="info-box-content">
                                        <span class="info-box-text">My Appointments</span>
                                        <span class="info-box-number" id="num_appoint" runat="server"></span>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="info-box bg-white">
                                    <span class="info-box-icon push-bottom bg-warning"></span>
                                    <div class="info-box-content">
                                        <span class="info-box-text">My Patients</span>
                                        <span class="info-box-number" id="num_new_pat" runat="server"></span>
                                        <span class="progress-description">
                                            New Patients
                                        </span>
                                    </div>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="info-box bg-white">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Past Appointments</span>
                                        <span class="info-box-number" id="num_past_appoint" runat="server">0</span>
                                        <span class="progress-description">
                                            This Month
                                        </span>
                                    </div>
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body ">
                                    <div class="table-wrap">
                                        <div class="table-responsive" id="newPatTable" runat="server">
