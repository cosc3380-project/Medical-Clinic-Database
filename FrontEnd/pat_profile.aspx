...
<script language="C#" runat="server">
    ...
    void loadUserData(HttpCookie uInfo)
    {
        ...
        if (objDataReader.Read())
        {
            ...
            DateTime doc_dob = Convert.ToDateTime(objDataReader["Pat_DOB"]);

            //Set page placeholders
            namePlate.InnerHtml = "<p>" + fName + " " + lName + "</p>";
            name.InnerHtml = fName + " " + lName;
            gender.InnerHtml = objDataReader["Pat_Gender"].ToString();
            dob.InnerHtml = doc_dob.ToShortDateString();
            email.InnerHtml = objDataReader["Pat_Email"].ToString();
            phone.InnerHtml = objDataReader["Pat_Phone"].ToString();
            street.InnerHtml = objDataReader["Pat_Addr_Street"].ToString();
            street2.InnerHtml = objDataReader["Pat_Addr_2"].ToString();
            city.InnerHtml = objDataReader["Pat_Addr_City"].ToString();
            state.InnerHtml = objDataReader["Pat_Addr_State"].ToString();
            zip.InnerHtml = objDataReader["Pat_Addr_Zip"].ToString();
        }
        objDataReader.Close();
        myConnection.Close();
    }
                                        ...
                                        <div class="card ">
                                            <div class="card-body no-padding height-9">
                                                <div class="profile-usertitle">
                                                    <div class="profile-usertitle-name" id="name" runat="server"></div>
                                                </div>
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item">
                                                        <b>Gender</b> <span class="pull-right" id="gender" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>DOB</b> <span class="pull-right" id="dob" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>Email</b> <span class="pull-right" id="email" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>Primary Phone #</b> <span class="pull-right" id="phone" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>Address 1</b> <span class="pull-right" id="street" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>Address 2</b> <span class="pull-right" id="street2" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>City</b> <span class="pull-right" id="city" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>State</b> <span class="pull-right" id="state" runat="server"></span>
                                                    </li>
                                                    <li class="list-group-item">
                                                        <b>Zip Code</b> <span class="pull-right" id="zip" runat="server"></span>
                                                    </li>
                                                </ul>
