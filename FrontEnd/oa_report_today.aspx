...
<script language="C#" runat="server">
    ...
    void loadreportinfoTable()
    {
        ...
        string strforappt_appt_day = "SELECT DISTINCT Appt_Date,Appt_Pat_ID FROM appointment ";
        string strConnect;
        ...
        SqlCommand myCommand_appt_day = new SqlCommand(strforappt_appt_day, myConnection);


        SqlDataReader objDataReader, objDataReader_pat, objDataReader_doc, objDataReader_staff, objDataReader_appt, objDataReader_appt_pat_id, objDataReader_appt_date, objDataReader_appt_day;
        ...
        string tableOut2 = "<table id='tableExport' style='width:100%'>";
        ...
        objDataReader_appt_day = myCommand_appt_day.ExecuteReader();
        int total_appt_day= 0;
        while (objDataReader_appt_day.Read())
        {
            // Use the row data, presumably
            //myList.Add(objDataReader_appt_date["Appt_Date"]);
            DateTime day = Convert.ToDateTime(objDataReader_appt_day["Appt_Date"]);
            if (day.Day == DateTime.Today.Day)
            {
                total_appt_day++;
                myList.Add(objDataReader_appt_day["Appt_Pat_ID"]);
            }

            //myList.Add( objDataReader_appt_pat_id["Appt_Pat_ID"]);

        }
        objDataReader_appt_day.Close();
        ...
        tableOut2 += "<td>" +myList.Count + "<td>"+(total_appt_day-myList.Count) + "<td>"+total_appt_day + "<td>"+total_appt_day;
