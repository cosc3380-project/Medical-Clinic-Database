...
<script language="C#" runat="server">
    ...
    void displaySubmitMsg(){
        ...
        string outMessage = "";
        if(submit == "y"){
            outMessage = "<font color=\"green\">Diagnosis has been created.</font>";
        }
        submitMsg.InnerHtml = outMessage;
    }
    void insertDiagTable(object sender, EventArgs e)
    {
        string strInsert;
        string strConnect;
        ...
        /*
        string strSelect;
        strSelect ="select * FROM diagnosis WHERE Diag_Appt_ID = @apptid AND Diag_Desc = @diagmsg";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        */
        ...
        strInsert ="INSERT INTO diagnosis (Diag_Appt_ID, Diag_Desc, Diag_Deleted) VALUES (@apptid, @diagmsg, 0)";
        ...
        myCommand.Parameters.AddWithValue( "@diagmsg", desc.Text);

        myCommand.ExecuteNonQuery();
        myConnection.Close();
        displaySubmitMsg();
    }
    void displaySumbitButton(){
        string outMessage = "<a href='oa_add_diagnosis.aspx?&submit=y&apptid=" + Request.QueryString.Get("apptid") + "' class='btn btn-tbl btn-xs'/><i>Submit</i></a>";
        outMessage += "<a href='oa_current_appointment.aspx' class='btn btn-tbl btn-xs'/><i>Cancel</i></a>";
        subAppt.InnerHtml = outMessage;
    }
</script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Diagnosis</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <form id="updateForm" class="form-horizontal" runat="server">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox runat="server" id="desc" placeholder="Diagnosis" class="form-control input-height" maxlength="50"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <asp:RequiredFieldValidator ID="diagnosisRequiredValidator" runat="server" ErrorMessage="Diagnosis is required" ControlToValidate="desc" Display="None"></asp:RequiredFieldValidator>
                                        ...
                                        <div style="text-align:center">
                                            <asp:Button ID="submitButton" Text="Submit" OnClick="insertDiagTable" runat="server" class="btn btn-tbl btn-xs" UseSubmitBehavior="False" />
