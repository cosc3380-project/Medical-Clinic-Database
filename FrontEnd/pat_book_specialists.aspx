...
<script language="C#" runat="server">
    ...
    void loadFutureApptTable()
    {
        ...
        strSelect ="SELECT Doc_Name_F, Doc_Name_L, Doc_Email, Doc_Phone, Doc_Specialization, Doc_Addr_City, Doc_Addr_State FROM doctor d";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        while(objDataReader.Read())
        {
            ...
            tableOut += "<td><a href='edit_doctor.html' class='btn btn-tbl-edit btn-xs'><i class='fa fa-check'></i></a></td>";
            tableOut += "</tr>";
        }
        tableOut += "</table>";
	                ...
	                <div id="remove-scroll" class="left-sidemenu">
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
	                        ...
	                        <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                                <li class="nav-item  ">
	                                    <a href="pat_book_specialists.aspx" class="nav-link "> <span class="title">Book Specialists</span>
	                                    </a>
	                                </li>
									<li class="nav-item  ">
	                                    <a href="pat_book_appointment.aspx" class="nav-link "> <span class="title">Book Appointment</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item  ">
	                                    <a href="pat_edit_appointment.aspx" class="nav-link "> <span class="title">Edit Appointment</span>
	                                    </a>
	                                </li>    	                                 
	                                <li class="nav-item  ">
