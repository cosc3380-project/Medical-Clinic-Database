...
<script language="C#" runat="server">
    ...
    void validate(Object sender, EventArgs e)
    {
        ...
        if(uInfo != null)
        {
            ...
            if (Page.IsValid)
            {
                ...
                strSelectA ="SELECT OA_Email FROM office_admin WHERE OA_Email = @email AND OA_ID <> @EID";
                strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
    ...
    void insertAdminTable(HttpCookie uInfo)
    {
        string strInsert;
        string strConnect;
        ...
        strInsert ="INSERT INTO office_admin " +
                "(OA_Name_F, OA_Name_L, OA_Gender, OA_Email, OA_Phone, OA_DOB, OA_Addr_Street, OA_Addr_2, OA_Addr_City, OA_Addr_State, OA_Addr_Zip,OA_Role,OA_Off_ID)" +
                " VALUES (@fname, @lname, @gender, @email, @phone,@dob, @street,@street2,@city,@state,@zip,@spec,@office)";
        ...
        void insertLoginTable(HttpCookie uInfo)
        {
            ...
            strSelect ="SELECT OA_ID FROM office_admin WHERE OA_Email = @email";
            SqlCommand myCommandA = new SqlCommand(strSelect, myConnection);
            myCommandA.Parameters.AddWithValue( "@email", email.Text );
            SqlDataReader objDataReader;
            objDataReader = myCommandA.ExecuteReader();
            if(objDataReader.Read())
                uid = "" + objDataReader["OA_ID"];
            objDataReader.Close();

            //Insert patient login data into login table
            strInsert ="INSERT into login (Log_User_Name,Log_Pass,Log_EID,Log_User_Type) VALUES (@uName,@uPass,@oaID,'A')";
            ...
            myCommandB.Parameters.AddWithValue( "@oaID", uid);
                                    ...
                                    <form id="updateForm" class="form-horizontal" runat="server">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <asp:DropDownList ID="spec" runat="server" style="width:100%" class="form-control input-height" >
                                            ...
                                            <!-- Office -->
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Office Location
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <asp:DropDownList ID="office" runat="server" style="width:100%" class="form-control input-height" >
                                                        <asp:ListItem></asp:ListItem>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <div class="row">
                                                    <<div class="offset-md-3 col-md-9">
                                                        ...
                                                        <asp:button runat="server" type="button" class="btn btn-default" Text="Cancel"></asp:button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
