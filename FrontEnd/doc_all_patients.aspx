...
<script language="C#" runat="server">
    ...
    void loadMyPatTable(HttpCookie uInfo)
    {
        //Loads components specific to the current doctor's previous patients
        string strSelect;
        string strConnect;

        strSelect = "SELECT Pat_Name_F, Pat_Name_L, Pat_Gender, Pat_DOB as 'Age' FROM doctor d, patient p, appointment a WHERE Doc_ID = @EID AND d.Doc_ID = a.Appt_Doc_ID AND p.Pat_ID = a.Appt_Pat_ID";
        strConnect = "server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        tableOut += "<thead><tr><td>Name</td><td>DOB</td><td>Gender</td></tr></thead>";
        while (objDataReader.Read()) {
            tableOut += "<tr class='odd gradeX'>";
            tableOut += "<td>" + objDataReader["Pat_Name_F"].ToString() + " " + objDataReader["Pat_Name_L"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["Age"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["Pat_Gender"].ToString() + "</td></tr>";
        }
        tableOut += "</table>";

        //Set page placeholders
        myPatTable.InnerHtml = tableOut;
        objDataReader.Close();
        myConnection.Close();
    }
</script>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card  card-box">
                                                    <div class="card-body ">
                                                        <div class="table-scrollable" id="myPatTable" runat="server">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
