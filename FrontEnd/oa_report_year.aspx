...
<script language="C#" runat="server">
    ...
    void loadreportinfoTable()
    {
        ...
        SqlDataReader objDataReader, objDataReader_pat, objDataReader_doc, objDataReader_staff,objDataReader_appt,objDataReader_appt_pat_id;
        ...
        tableOut2 += "<td>" + countforappt_pat_id + "<td>"+(countforappt-countforappt_pat_id) + "<td>"+countforappt + "<td>"+countforappt;
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card  card-box">
                                                    ...
                                                    <div class="card-body ">
                                                        <div id="reportinfoTable" runat="server">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
