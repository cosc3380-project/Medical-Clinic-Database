...
<script language="C#" runat="server">
    ...
    void loadDiagnosisTable(HttpCookie uInfo)
    {
        //Loads components specific to appointment count
        string strSelect;
        string strConnect;

        strSelect ="SELECT Diag_Desc, Doc_Name_F, Doc_Name_L, Appt_Date FROM patient p, doctor d, appointment a, diagnosis di WHERE di.Diag_Appt_ID = a.Appt_ID AND p.Pat_ID = a.Appt_Pat_ID AND d.Doc_ID = a.Appt_Doc_ID AND Diag_Deleted <> 1 AND p.Pat_ID = @EID";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        tableOut += "<thead><tr><td>Date</td><td>Doctor Name</td><td>Diagnosis</td></tr></thead>";
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Diagnosis History</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
