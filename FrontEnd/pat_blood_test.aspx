...
<script language="C#" runat="server">
    ...
    void loadBTTable(HttpCookie uInfo)
    {
        //Loads components specific to appointment count
        string strSelect;
        string strConnect;

        strSelect ="SELECT BT_RBC, BT_WBC, BT_Platelet_Cnt, BT_Hgb, BT_Hct, BT_MCV, Appt_Date FROM patient p, appointment a, blood_test b WHERE b.BT_Appt_ID = a.Appt_ID AND p.Pat_ID = a.Appt_Pat_ID AND BT_Deleted <> 1 AND p.Pat_ID = @EID";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        tableOut += "<thead><tr><td>Date</td><td>RBC</td><td>WBC</td><td>Platelet Count</td><td>HGB</td><td>HCT</td><td>MCV</td></tr></thead>";
        while(objDataReader.Read())
        {
            tableOut += "<tr class='odd gradeX'>";
            tableOut += "<td>" + objDataReader["Appt_Date"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["BT_RBC"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["BT_WBC"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["BT_Platelet_Cnt"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["BT_Hgb"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["BT_Hct"].ToString() + "</td>";
            tableOut += "<td>" + objDataReader["BT_MCV"].ToString() + "</td>";
            tableOut += "</tr>";
        }
        tableOut += "</table>";
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Blood Test Result History</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
