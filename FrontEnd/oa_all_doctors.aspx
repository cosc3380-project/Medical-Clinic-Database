...
<script language="C#" runat="server">
    ...
    void loadDocTable()
    {
        ...
        strSelect ="SELECT Doc_Name_F, Doc_Name_L, Doc_Email, Doc_Phone, Doc_Specialization from doctor";
        strConnect="server=AUCKLAND;database=gl1517;uid=gl1517;pwd=MSX44gdnE";
        ...
        tableOut += "<thead><tr><td class='font-weight-bold' style='width:25%'>Name</td><td class='font-weight-bold'>Role</td><td class='font-weight-bold'>Phone</td><td class='font-weight-bold'>Email</td></tr></thead>";
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle " src="img/hospital.svg" />
                            </a>
